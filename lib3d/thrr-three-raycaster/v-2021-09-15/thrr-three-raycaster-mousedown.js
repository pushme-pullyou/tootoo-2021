...
file name: ${ mesh.name}<br>
extension: ${ mesh.userData.extension}<br>
type: ${ mesh.userData.type}<br>
vertex colors:  ${ mesh.material.vertexColors }<br>
color:  ${ mesh.material.color.r }  ${ mesh.material.color.g }  ${ mesh.material.color.b }<br>
