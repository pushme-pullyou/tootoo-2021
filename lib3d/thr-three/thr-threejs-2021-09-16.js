let group, axesHelper, lightDirectional, directionalLightHelper, shadowCameraHelper;
...
<p>
	...
	Draw calls: ${ render.calls.toLocaleString() }<br>
	Triangles: ${ render.triangles.toLocaleString() }<br>
	Geometries: ${ renderer.info.memory.geometries.toLocaleString() }<br>
	Textures: ${ renderer.info.memory.textures.toLocaleString() }<br>
