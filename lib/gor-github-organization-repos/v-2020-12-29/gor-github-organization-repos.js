...
GOR.init = function () {
	...
	const htm = `
			<details open>
				...
				<div class=divNavResize>
					...
					<label for="GOPinpUser">Choose a user:</label>
					<input type=search list="GORlistUsers" id="GOPinpUser" oninput=GOR.getOrganization(this.value);
	...
	GOPinpUser.value = "pushme-pullyou/tootoo-2021"
...
GOR.getOrganization = function ( value = GOPinpUser.value ) {
