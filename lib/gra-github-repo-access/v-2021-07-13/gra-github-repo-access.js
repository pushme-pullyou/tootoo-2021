...
GRA.init = () => {
	...
	GRA.info = `
<p>
	Provide the parameters needed to make a GitHub API call - required to access private repositories<br>
	<button onclick=GRA.testSwitchPP() >test switch pp</button><br>
	<button onclick=GRA.test() >test call API</button>
</p>
File name: gra-github-repo-access.js<br>
Name space: GRA<br>
Release: 2021-07-13<br>
`;
...
<details id=GRAdet >
	...
	<summary id=GRAsumRepo class="summary-secondary gmd-2" title="View selected items">
