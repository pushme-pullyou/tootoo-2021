...
GRA.init = () => {
	...
	GRAdivGitHubRepoAccess.innerHTML = `

<details id=GRAdetMenu open>
	...
	<summary class="summary-primary gmd-1" title="View selected items">
		...
		<span class="info">
			...
			<div class="infoTooltip gmd-5">
				Provide the parameters needed to make a GitHub API call
				<button onclick=GRA.testSwitchPP() >test switch pp</button>
				<button onclick=GRA.testSwitchTheo() >test switch theo</button>
