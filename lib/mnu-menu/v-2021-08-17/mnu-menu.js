...
<details id=detFile>
	...
	<summary class="summary-primary gmd-1" title="Open files on your device: ">MNU file menu
		<span id=MNUspnFile >bbbbbb</span>
		${ MNU.addInfoBox( "Files to try" ) }
	</summary>
...
<details class=detNavMenu id=detData ontoggle=JTV.init();JTV.onLoad();>
	...
	<summary class="summary-primary gmd-1" title="Browse the data in the file">
	MNU data menu ${ MNU.addInfoBox( "lorem ipsum, quia dolor sit, amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt, ut labore et dolore magnam aliquam quaerat voluptatem.ut enim ad minima tempora incidunt, ut labore et dolore magnam aliquam quaerat voluptatem. ut enim ad minima" ) }
	</summary>
