...
MNU.init = function ( htm = COR.description ) {
	...
	const infoHtml = `${ htm }<br> version <span> ${ MNU.version }</span >`;

	MNU.source = `https://github.com/${ MNU.user}/${ MNU.repo }/`;
...
<footer>
	...
	<center>
		<a id=MNUaIcon class=aDingbat href="javascript:MNUaSource.scrollIntoView();" title="Scroll to top" >❦</a>
	</center>
...
MNU.addInfoBox = function ( html = MNU.description ) {
	console.log( { html } );
	htm = `
&nbsp;
<span class="info">
