...
MNU.init = function ( { description = `<p>${ COR.description }</p>version <span> ${ COR.version }</span >` } = {} ) {
	...
	MNU.source = `https://github.com/${ COR.user}/${ COR.repo }/`;
...
<header>
	...
	<h1>
		<a id=MNUaSource href=${ MNU.source } target="_top" title="Click to go to the source code on GitHub">
			<img src="${ COR.path }/lib/assets/icons/mark-github.svg">
		</a>
...
MNU.addInfoBox = function ( html = COR.description ) {
	//console.log( { html } );
	htm = `
&nbsp;
<span class="info">
	<img class=infoImg src="${ COR.path }/lib/assets/icons/noun_Information_585560.svg">
