...
TED.onHashChange = () => {
	...
	TED.fileTitle = fileName.split( "/" ).pop();
	TED.extension = TED.fileTitle.toLowerCase().split( '.' ).pop();
	TED.url = TED.path + TED.fileName;
