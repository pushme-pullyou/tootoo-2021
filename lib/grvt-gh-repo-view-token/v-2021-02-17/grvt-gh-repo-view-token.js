	...
	const htm = `
			<details open>
				...
				<div class=divNavResize>
					...
					<p><button onclick=divContentMain.contentEditable=true; >edit content</button></p>
...
GRVT.setGitHubAccessToken = function () {
	...
	GRVT.accessToken = GRVTinpGitHubApiKey.value;

	console.log( 'accessToken', GRVT.accessToken  );

	localStorage.setItem( "githubAccessToken", GRVT.accessToken  );
