...
XGP.url = "https://api.github.com/repos/theo-armour/qdata/contents/journal/days-of-year-md/02/02-06.md";
...
`;
	...
	//XGP.content = divContentMain.innerText = localStorage.getItem( "file-2021-02-05-text" ) || "";
...
XGP.getStorage = function () {
	...
	divContentMain.innerText = XGP.content;
...
XGP.setStorage = function() {
	...
	XGP.content = divContentMain.innerText;
...
XGP.putFile = function () {
	...
	const content = divContentMain.innerText;
...
XGP.readFile = function ( files ) {
	...
	reader.onload = function ( event ) {
		...
		XGP.content = divContentMain.innerText = reader.result;
...
XGP.saveFile = function () {
	...
	const blob = new Blob( [ divContentMain.innerText ] );
...
window.addEventListener( 'beforeunload', function ( event ) {
	...
	if ( divContentMain.innerText !== XGP.content ) {
