...
OBJ.loadMtl = function ( file, fileMaterial ) {

	const loaderMaterial = new THREE.MTLLoader();
	const reader = new FileReader();

	reader.onload = () => {

		const material = loaderMaterial.parse( reader.result );
		OBJ.loadObj( file, material );
